...
if(WIN32)
    ...
    SET(MKLDNN_LIB_1 "${MKLDNN_INSTALL_DIR}/${LIBDIR}/libdnnl.so.2" CACHE FILEPATH "mkldnn library." FORCE)
    SET(MKLDNN_LIB_2 "${MKLDNN_INSTALL_DIR}/${LIBDIR}/libdnnl.so.2.2" CACHE FILEPATH "mkldnn library." FORCE)
endif(WIN32)
...
#             COMMAND ${CMAKE_COMMAND} -E copy ${MKLDNN_LIB} ${MKLDNN_SHARED_LIB_2})
    SET(MKLDNN_SHARED_LIB   ${MKLDNN_INSTALL_DIR}/libdnnl.so)
    SET(MKLDNN_SHARED_LIB_1 ${MKLDNN_INSTALL_DIR}/libdnnl.so.2)
    SET(MKLDNN_SHARED_LIB_2 ${MKLDNN_INSTALL_DIR}/libdnnl.so.2.2)
    ADD_CUSTOM_COMMAND(TARGET ${MKLDNN_PROJECT} POST_BUILD
            COMMAND cp -a -f ${MKLDNN_LIB} ${MKLDNN_SHARED_LIB})
    ADD_CUSTOM_COMMAND(TARGET ${MKLDNN_PROJECT} POST_BUILD
            COMMAND cp -a -f ${MKLDNN_LIB_1} ${MKLDNN_SHARED_LIB_1})
    ADD_CUSTOM_COMMAND(TARGET ${MKLDNN_PROJECT} POST_BUILD
            COMMAND cp -a -f ${MKLDNN_LIB_2} ${MKLDNN_SHARED_LIB_2})
endif(WIN32)
